...
// function Location (name,mincustomers,maxcustomers,avgCoockies,Coockies,total,cust){
//     this.name=name;
...
//               var somthing = Math.floor(this.cust[i] * this.avgCoockies);
//               this.Coockies.push(somthing);
//               this.total = this.total + this.Coockies[i];
//           }
//         }
//   //     for (let i = 0; i < workingHours.length; i++) {
//   //  var anything  = Math.floor(Math.random() * (this.maxcustomers -this.mincustomers) + this.mincustomers);
